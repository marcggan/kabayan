<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddBooking.aspx.cs" Inherits="admin_AddBooking" %>
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
            <br/><br/>
            <asp:Button class="btn btn-primary btn-block" ID="btnAdd" runat="server" Text="Add" onclick="btnAdd_Click" CausesValidation="True" />
            </div>
            <div class="col-xs-6">
            <br/><br/>
